...
Last updated: June 19, 2026 (Session 5 — temporary backend migration to personal Google account)
...
**Known limitation:** `doPost` uses `no-cors` — app cannot confirm log succeeded. Monitor Sheet periodically.
